...
namespace CarsCrudApi.Cars.Controller
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Bike>> GetName([FromRoute] string name)
        {
        ...
        public async Task<ActionResult<Bike>> CreateProduct([FromBody] CreateCarRequest createCarRequest)
        {
